...
from doc import load_data, Example,entity_dict,train_triplet_dict
from predict import BertPredictor
from dict_hub import get_entity_dict, get_all_triplet_dict
from triplet import EntityDict
from rerank import rerank_by_ans
...
@torch.no_grad()
def compute_metrics(predictor: BertPredictor,hr_dict: dict,
                    ent_dict: dict,
                    target: List[int],
...
def eval_single_direction(predictor: BertPredictor,
    ...
    topk_scores, topk_indices, metrics, ranks = compute_metrics(predictor=predictor,hr_dict=hr_dict, ent_dict=ent_dict, target=target, examples=examples)
