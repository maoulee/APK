...
from triplet import TripletDict, EntityDict, LinkGraph,TripletDict_graph
from logger_config import logger

train_triplet_dict: TripletDict_graph = None
...
def _init_train_triplet_dict():
    ...
    if not train_triplet_dict:
        train_triplet_dict = TripletDict_graph(path_list=[args.train_path])
