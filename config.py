...
parser = argparse.ArgumentParser(description='ASPKGC arguments')
...
parser.add_argument('--precode', action='store_true',
                    help='is in test mode or not')
parser.add_argument('--ans', default=1, type=int,
...
assert args.task.lower() in ['wn18rr', 'fb15k237', 'dbpedia50k', 'fb20k']
